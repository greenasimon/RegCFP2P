...
csvheaders = [["FormType","AccessionNum","PublicDocCount", "CIK", "FileNumber", "FilmNumber", "FiledDate","ChangeDate",
               ...
               #document tags
               "filercik", "liveflag", "ConfirmCopy", "ReturnCopy", "OverrideInternet",
               "IssuerName","IssuerSign", "IssuerTitle", "PersonSign", "PersonTitle"]]
outFile = open('Form_W.csv','w', newline= '')
inputData = []
#for the text part
SecHeaders = ["CONFORMED SUBMISSION TYPE", "ACCESSION NUMBER","PUBLIC DOCUMENT COUNT", "CENTRAL INDEX KEY",
              "SEC FILE NUMBER", "FILM NUMBER",
...
DocHeaders = ["filercik", "livetestflag", "confirmingcopyflag", "returncopyflag", "overrideinternetflag",
              "nameofissuer", "issuersignature", "issuertitle", "personsignature", "persontitle"]
...
def ExtractTagElement( parentSoup, childTag ):
    ...
    return ret
#File Locations
Locations = ["/projects/academic/bawolfe/pullman/forms/RegCF/Edgar filings/ALL_C-U-W_2017",
             "/projects/academic/bawolfe/pullman/forms/RegCF/Edgar filings/ALL_CA-W_2016",
             "/projects/academic/bawolfe/pullman/forms/RegCF/Edgar filings/ALL_CA-W_2017",
             "/projects/academic/bawolfe/pullman/forms/RegCF/Edgar filings/ALL_C-W_2016",
             "/projects/academic/bawolfe/pullman/forms/RegCF/Edgar filings/ALL_C-W_2017",
             "/projects/academic/bawolfe/pullman/forms/RegCF/Edgar filings/ALL_C-TR_2017"]
