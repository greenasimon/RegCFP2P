...
csvheaders = [["FormType","AccessionNum","PublicDocCount", "CIK", "FileNumber", "FilmNumber", "FiledDate","ChangeDate",
               ...
               #document tags
               "filercik", "liveflag", "ConfirmCopy", "ReturnCopy", "OverrideInternet", "IsAmendment", "NatureOfAmendment",
               "IssuerName", "OrgStatus", "OrgJurisdiction", "DateInc", "IssuerStreet", "IssuerCity", "IssuerState",
               "IssuerZip", "website", "PortalName", "PortalCIK", "PortalFileNum", "CompAmount", "FinInterest",
               "SecurityType", "SecurityNum", "SecPrice", "PriceMethod", "OfferingAmt", "OverSub", "OverSubType",
               "DescOversub",  "MaxOfferAmt", "Deadline", "Employees", "TotalAssetFY1", "TotalAssetFY2",
...
outFile = open('Form_CA_2017.csv','w', newline= '')
inputData = []
#for the text part
...
DocHeaders = ["filercik", "livetestflag", "confirmingcopyflag", "returncopyflag", "overrideinternetflag", "isamendment",
              "natureofamendment", "nameofissuer",
...
os.chdir("/projects/academic/bawolfe/pullman/forms/RegCF/Edgar filings/ALL_CA_2017")
